<?php 
  ...
  $sql = mysqli_query($conn,"SELECT * FROM auctions");
...
<body>
            ...
            <div class="custom_select">
              <select   name="cate">
                ...
                <?php while($row = mysqli_fetch_assoc($sql)){?>
                  <option value="<?php echo $row['AuctionID'] ?> " <?php if($idauc == $row['AuctionID']){ echo "selected";} ?>><?php echo $row['Title'] ?></option>
                <?php }?>
              </select>
            </div>
          </div>
  ...
  <script src="./js/BackendJs/createGallery.js"></script>
</body>
</html>